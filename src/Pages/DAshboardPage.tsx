            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  <a href="#"
                     className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Reports</a>
                </div>
              </div>
            </div>
            <div className="hidden md:block">
                ...
                <el-dropdown className="relative ml-3">
                  <button
                    ...
                    <img
                      ...
                      alt="" className="size-8 rounded-full outline -outline-offset-1 outline-white/10"/>
                  </button>
